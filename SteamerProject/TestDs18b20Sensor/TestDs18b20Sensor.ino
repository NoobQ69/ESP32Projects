...
unsigned int Temperature = 100, RoomTemperature = 0x888;
unsigned char KeyBuffer[3] = {0, 0, 0}; // 0: Mode Stop, 1: Mode Start

unsigned int PreviousTime = 0, PreviousSecond = 0, CurrentTime, TimeInterval = 10, UpToOneTime = 2000; // 30ms
